# Graph Report - self-shield  (2026-05-10)

## Corpus Check
- 150 files · ~92,379 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 886 nodes · 1816 edges · 32 communities detected
...
Cohesion: 0.06
Nodes (102): _acquireLock(), _adminDeletePasskey(), _adminListPasskeys(), _approveAuthorization(), _authenticate(), _autoRefreshTokenTick(), Bt(), _callRefreshToken() (+94 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (76): _cancelPendingDisconnect(), cancelRefEvent(), cancelTimeout(), canPush(), clearHeartbeats(), close(), closeAndRetry(), connect() (+68 more)
...
Cohesion: 0.08
Nodes (52): Error, _binaryDecode(), binaryEncode(), _binaryEncodeUserBroadcastPush(), br(), _challenge(), copyBindings(), cr() (+44 more)

### Community 6 - "Community 6"
Cohesion: 0.09
Nodes (32): clone(), cloneRequestState(), containedBy(), contains(), delete(), dr(), from(), _getUrlForProvider() (+24 more)
...
## Knowledge Gaps
- **19 isolated node(s):** `MainViewModel`, `AuthState`, `Authenticated`, `Unauthenticated`, `SelfShieldApplication` (+14 more)
...
- **Thin community `Community 15`** (7 nodes): `SelfShieldAccessibilityService`, `.handleWhatsApp()`, `.onAccessibilityEvent()`, `.onInterrupt()`, `.performBlockAction()`, `.tryClick()`, `SelfShieldAccessibilityService.kt`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 16`** (6 nodes): `DeviceRepository`, `.checkPairingStatus()`, `.claimDevice()`, `.registerDevice()`, `DeviceStatus`, `DeviceRepository.kt`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `Error` connect `Community 5` to `Community 0`, `Community 1`, `Community 2`, `Community 6`, `Community 7`, `Community 10`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `Error` connect `Community 5` to `Community 0`, `Community 1`, `Community 2`, `Community 6`, `Community 7`, `Community 12`?**
