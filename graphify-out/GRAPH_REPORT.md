...
## Summary
- 770 nodes · 1648 edges · 15 communities detected
...
Cohesion: 0.05
Nodes (111): _acquireLock(), _adminDeletePasskey(), _adminListPasskeys(), _approveAuthorization(), _autoRefreshTokenTick(), br(), Bt(), _callRefreshToken() (+103 more)
...
Cohesion: 0.09
Nodes (30): _authenticate(), _binaryDecode(), _challenge(), _challengeAndVerify(), decode(), decodeBroadcast(), decodePush(), decodeReply() (+22 more)
